...
import TodayTask.dto.ErrorClass;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TodayTaskException.class)
    public ResponseEntity<ErrorClass> handleTodayTaskException(TodayTaskException ex) {
        ...
        switch (errorCode) {
            ...
            default:
                log.error("TodayTask  Exception: " + errorCode + " - " + ex.getMessage(), ex);
                errorClass = new ErrorClass(errorCode, ex.getMessage());
