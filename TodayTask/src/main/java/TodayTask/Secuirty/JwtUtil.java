...
public class JwtUtil {
    ...
    public Long getUserIdFromHttpServletRequest(HttpServletRequest request){
        ...
        if (authorizationHeader == null || !authorizationHeader.startsWith("Bearer ")) {
            throw new TodayTaskException("Authorization header is missing or invalid", HttpStatus.UNAUTHORIZED.toString());
        }
        ...
        if(Objects.isNull(user)){
            throw new TodayTaskException("No Active user is present for this user", HttpStatus.UNAUTHORIZED.toString());
